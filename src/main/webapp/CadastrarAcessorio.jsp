...
<html lang="PT-BR">
    <head>
        <meta charset="utf-8">
        <title>Jupiter - Cadastro de Acessórios</title>
    ...
    <body>
        ...
        <div id="corpo">
            <form action="${pageContext.request.contextPath}/CadastrarAcessorio" method="post" id="formularioCadastro">
                ...
                <input type="text" name="txtPlataforma" placeholder="PLATAFORMA" class="formulario">
                </br></br>
